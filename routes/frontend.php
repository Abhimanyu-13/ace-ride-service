...
Route::group(['middleware' => ['domain']], function () {
	...
	Route::get('user/deleteAccount', [
		'as' => 'customer.deleteAccountForm',
		'uses' => 'Front\CustomerAuthController@deleteAccountForm'
	]);
	...
	Route::post('user/account/delete', 'Front\CustomerAuthController@deleteAccount')->name('customer.deleteAccount');
...
Route::get('getuserbyphone', 'Client\UserController@getuserbyphone')->name("user.getuserbyphone");

Route::post('registercustom', 'Client\UserController@registeruser')->name('user.registeruserbyphone');