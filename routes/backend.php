...
Route::group(['middleware' => 'adminLanguageSwitch'], function () {
    Route::group(['middleware' => ['ClientAuth', 'database','permission'], 'prefix' => '/client'], function () {
        ...
        Route::post('vendor/updateSlotAvailability', 'Client\VendorController@updateSlotAvailability')->name('vendor.config.updateSlotAvailability');
...
Route::get('product/addonget', 'Client\ProductController@getaddons')->name('getaddons.product.clients');
Route::post('product/addonsave', 'Client\ProductController@saveaddons')->name('saveaddons.product.clients');
Route::get('product/deleteaddons', 'Client\ProductController@deleteaddons')->name('deleteaddons.product.clients');