  ...
  <div class="addManualTime">
    <div class="addManualTimeGroup" style="text-align:left;">
      <div class="single_cart-temp_label">
        <label class="text-left mb-0">{{__('Start/Date Time')}}</label>
        <label class="text-left mb-0">{{__('End/Date Time')}}</label>
      </div>
      ...
      <div class="mt-0">{{__('Duration') }}:
        ...
        <div class="qty-box mb-3">
            <div class="input-group">
                  ...
                  <input style="width: 135px" readonly type="text"  id="incremental_hrs_hidden" class="form-control input-qty-number"  value="{{$product->minimum_duration. ' ' . __('hour') . ' ' .$product->minimum_duration_min. ' ' . __('min')}}">
