                            ...
                            <div class="al_details_vendor p-2 mb-3">
                                ...
                                <div class="form-row">
                                    <div class="col-12 checkbox-input" id="check_conditionsCheckbox">
                                        ...
                                        <label for="check_conditions">{{__('I accept the')}} <a href="{{url('page/terms-and-conditions')}}" target="_blank">{{__('Terms And Conditions')}}</a> {{__('and have read the')}} <a href="{{url('page/privacy-policies')}}" target="_blank"> {{__('Privacy Policy.')}}</a></label>
