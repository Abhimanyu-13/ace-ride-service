    ...
    <div class="cab-content-area">
        ...
        <section class="royo-business p-0">
            <div class="container p-64 pl-0 pr-0">
                <div class="row">
                    <div class="col-12">
                        <h2 class="title-36">Welcome to Cab Service</h2>
                        <div class="description-text">
                            <p>Book Your Reliable and Convenient Rides with Scuber Taxi.
                               we understand the importance of reaching your destination safely, comfortably, and on time. Whether you're a frequent traveler, 
                               a tourist exploring a new city, or simply need a reliable ride for your daily commute, we've got you covered. 
                               With our seamless online booking platform and a fleet of well-maintained vehicles, we strive to provide you with the best transportation 
                ...
                <div class="row align-items-center p-64">
                    <div class="col-sm-6">
                        <div class="cab-img-box">
                            <img class="img-fluid" src="https://s3.us-west-2.amazonaws.com/royoorders2.0-assets/prods/q3sMtd33rU53AH1sKZHFHRJFZMY1P1YmowfVEeEC.jpg" alt="">
                        </div>
                    </div>
                    <div class="offset-md-1 col-sm-6 col-md-5 pl-lg-4">
                        <div class="">
                            <h2 class="title-52">About Scuber Taxi</h2>
                            <div class="description-text">
                                <p>Scuber Taxi is the future of cab services. We are revolutionize transportation by providing convenient, 
                                    reliable, and safe travel solutions. With a strong focus on Scuber Taxis, innovation, scalability, and 
                                    economic impact. Scuber Taxi will transform the ride-hailing industry. We are a 100% Indian Startup and .
                                    wants to serve our country.</p>
                            </div>
