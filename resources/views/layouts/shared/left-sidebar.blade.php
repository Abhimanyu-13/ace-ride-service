                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarreports">
                                    <ul class="nav-second-level">
                                        ...
                                        <li>
                                            <a href="{{route('review.index')}}">{{ __('Service Reviews') }}</a>
                                        </li>
                                        @endif

                                        @if(@auth()->user()->can('review-product-performance') || Auth::user()->is_superadmin == 1)
                                        <li>
                                            <a href="{{route('report.productperformance')}}">{{ __("Service Performance Report") }}</a>
                                        </li>
                                        @endif
                                    </ul>
                                </div>
