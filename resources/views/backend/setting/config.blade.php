            ...
            <form method="POST" action="{{ route('configure.update', Auth::user()->code) }}" class="h-100">
                ...
                <div class="card-box h-100 h-100">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-2">
                                <label for="fcm_private_key_id">{{ __('Private Key ID') }}</label>
                                <input type="text" name="fcm_private_key_id" id="fcm_private_key_id" placeholder=""
                                    class="form-control"
                                    value="{{ old('fcm_private_key_id', $preference->fcm_private_key_id ?? '') }}" required>
                                @if ($errors->has('fcm_private_key_id'))
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $errors->first('fcm_private_key_id') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-2">
                                <label for="fcm_private_key">{{ __('Private Key') }}</label>
                                <input type="text" name="fcm_private_key" id="fcm_private_key" placeholder=""
                                    class="form-control"
                                    value="{{ old('fcm_private_key', $preference->fcm_private_key ?? '') }}" required>
                                @if ($errors->has('fcm_private_key'))
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $errors->first('fcm_private_key') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-2">
                                <label for="fcm_client_email">{{ __('Client Email') }}</label>
                                <input type="text" name="fcm_client_email" id="fcm_client_email" placeholder=""
                                    class="form-control"
                                    value="{{ old('fcm_client_email', $preference->fcm_client_email ?? '') }}" required>
                                @if ($errors->has('fcm_client_email'))
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $errors->first('fcm_client_email') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-2">
                                <label for="fcm_client_id">{{ __('Client ID') }}</label>
                                <input type="text" name="fcm_client_id" id="fcm_client_id" placeholder=""
                                    class="form-control"
                                    value="{{ old('fcm_client_id', $preference->fcm_client_id ?? '') }}" required>
                                @if ($errors->has('fcm_client_id'))
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $errors->first('fcm_client_id') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-2">
                                <label for="fcm_client_cert_url">{{ __('Client Cert URL') }}</label>
                                <input type="text" name="fcm_client_cert_url" id="fcm_client_cert_url" placeholder=""
                                    class="form-control"
                                    value="{{ old('fcm_client_cert_url', $preference->fcm_client_cert_url ?? '') }}" required>
                                @if ($errors->has('fcm_client_cert_url'))
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $errors->first('fcm_client_cert_url') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
