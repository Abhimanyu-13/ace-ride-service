...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content text-center">
      <div class="modal-body" id="donwloadadasdasdda">
            <?php 
      ...
      <input type="hidden" value="{{ ucfirst($vendor->name) }}" class="wshingstationnamere" />
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="downloadSVG()">Download</button>
      </div>
    </div>
  </div>
</div>
            ...
            <div class="col-12 d-md-flex align-items-center">
                ...
                <div class="form-group mb-0 ml-sm-3">
                    <div class="site_link position-relative">
                        ...
                        <div class="generateqr btn btn-primary ml-3 btn-block" data-toggle="modal" data-target="#exampleModal">View QR</div>
                        @endif
                    </div>
...
@section('script')
    ...
    function downloadSVG() {
        const svg = document.getElementById('donwloadadasdasdda').innerHTML;
        const blob = new Blob([svg.toString()]);
        const element = document.createElement("a");
        const name = $('.wshingstationnamere').val().toLowerCase();
        const asd = name+'.svg';

        console.log(asd);
        element.download = asd;
