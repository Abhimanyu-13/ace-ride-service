...
<script type="text/javascript">
    ...
    $(document).on('change', '.show_availability', function() {
        var val = $(this).data('vendor-id');
        ...
        $.ajax({
            ...
            url : "{{ route('vendor.config.updateSlotAvailability') }}",
            data : {
                'id' : val,
                'show_slot' : is_switched_on
            },
            type : 'POST',
            dataType : 'json',
        ...
        if(is_switched_on == true){
            $("#slot_"+val).removeClass('text-danger bg-soft-danger');
            $("#slot_"+val).addClass('text-success bg-soft-success');
            $("#slot_"+val).html('Open');
        }else{
            $("#slot_"+val).removeClass('text-success bg-soft-success');
            $("#slot_"+val).addClass('text-danger bg-soft-danger');
            $("#slot_"+val).html('Closed');
        }
    });
