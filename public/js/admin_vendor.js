            ...
            if(status == 1){
                return [
                    ...
                    {data: 'show_slot', name: 'show_slot', orderable: false, searchable: false, "mRender":function(data, type, full){
                        return "<span class='badge bg-soft-"+full.show_slot_label+" text-"+full.show_slot_label+"' id='slot_"+full.id+"'>"+full.show_slot_option+"</span> | <a class='action-icon edit_vendor' href='javascript:void(0)' data-vendor_id='"+full.id+"'><i class='mdi mdi-square-edit-outline'></i></a>";
                    }},
                    ...
                    {data: 'availablity_checkbox', name:'availablity_checkbox', orderable: false, searchable: false},
