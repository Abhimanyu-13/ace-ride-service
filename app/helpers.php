...
if (!function_exists('sendFcmCurlRequest')) {
    function sendFcmCurlRequest($data ,$fcm_server_key = '')
    {
        ...
        if (!empty($client_preferences->fcm_project_id)) {
            $projectId = $client_preferences->fcm_project_id;
            $privateKeyId = $client_preferences->fcm_private_key_id;
            $privateKey = str_replace("\\n", "\n", $client_preferences->fcm_private_key);
            $clientEmail = $client_preferences->fcm_client_email;
            $clientId = $client_preferences->fcm_client_id;
            $clientCertURL = $client_preferences->fcm_client_cert_url;
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => 'https://ace.genaiapp.io/sendPushnotification',
        ...
        // };
            ...
            // $projectId = "test-ace-abb62";

            /// imp
            // $credentialsFilePath = public_path('firebase/firebase_credentials.json');
...
// if (!function_exists('getClientCode')) {
//     //bcz s3 creds not provided yet
