...
use App\Models\ProductAddonscustom;
...
class ProductController extends BaseController
{
    ...
    public function edit($domain = '', $id)
    {
        ...
        $productadoncustom                  = ProductAddonscustom::where('product_id', $product->id)->get();
    ...
    public function saveaddons(Request $request, $id){
        ...
        if ($validation->fails()) {
            ...
            try {
                ...
                $product = new ProductAddonscustom();
                $product->product_id = $request->product_id;
                $product->name = $request->addonname;
                $product->price = $request->price;
                $product->item_code = $request->item_code;

                $product->save();

                $productadoncustom  = ProductAddonscustom::where('product_id',  $request->product_id)->get();
                return  redirect()->back()->withInput()->with('success', __($productadoncustom) );
